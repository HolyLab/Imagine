...
QT_MOC_LITERAL(6, 55, 13) // "mouseReleased"

    },
    "ImageLabel\0mousePressed\0\0QMouseEvent*\0"
    "event\0mouseMoved\0mouseReleased"
};
...
void ImageLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ImageLabel::*_t)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageLabel::mousePressed)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ImageLabel::*_t)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageLabel::mouseMoved)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (ImageLabel::*_t)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageLabel::mouseReleased)) {
                *result = 2;
                return;
            }
        }
