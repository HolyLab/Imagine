...
public:
    ...
    actionStartAcqAndSave->setIcon(QIcon(QString::fromUtf8(":/icons/Resources/start_acq.bmp")));
    actionStop = new QAction(ImagineClass);
    actionStop->setObjectName(QString::fromUtf8("actionStop"));
    actionStop->setIcon(QIcon(QString::fromUtf8(":/icons/Resources/stop.bmp")));
    ...
    actionStartLive->setIcon(QIcon(QString::fromUtf8(":/icons/Resources/start_live.bmp")));
    ...
    dockWidgetContents = new QWidget(dwStim);
    ...
    dockWidgetContents1 = new QWidget(dwLog);
    ...
    dockWidgetContents2 = new QWidget(dwCfg);
    ...
    dockWidgetContents_2 = new QWidget(dwHist);
    ...
    dockWidgetContents_3 = new QWidget(dwIntenCurve);
